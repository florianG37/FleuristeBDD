...
public class VoirFournitureTableTemplate extends AbstractTableModel
{
	private String[] entetes = {"Nom", "Categorie", "Espece", "Prix HT", "Prix TTC", "Quantite"};
	private ArrayList<Produit> produits; 
	
	public VoirFournitureTableTemplate(Fourniture fourniture)
	{
		produits = FournitureController.voirProduitDeLaFourniture(fourniture);
	}
